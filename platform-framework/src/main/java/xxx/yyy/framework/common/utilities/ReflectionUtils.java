...
//	 * @return
//	 */
//	public static  <T> List<GetterAnnotationInfo<T>> getGetterAnnotation(Class tagertClass,Class<T> annotationClass){
//
//		Method[]  methods  =  tagertClass.getMethods();
//		List<GetterAnnotationInfo<T>> infos = new ArrayList<GetterAnnotationInfo<T>>();
//
...
//				continue ;
//			}
//			T  annotation = (T) ReflectionUtils.getAnnotation(m, annotationClass);
//			if(annotation==null){
//				continue ;
//			}
//
//			String fieldName = ReflectionUtils.getFieldName(m.getName());
//			GetterAnnotationInfo<T> info = new GetterAnnotationInfo<T>();
