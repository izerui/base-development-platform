...
import xxx.yyy.sys.base.model.BaseTreeInfoModel;
...
public class Department extends BaseTreeInfoModel{
	...
	/**
	 * @param leader the {@link xxx.yyy.sys.rbac.model.Post} to set
	 */
	...
	/**
	 * @param superLeader the {@link xxx.yyy.sys.rbac.model.User} to set
	 */
